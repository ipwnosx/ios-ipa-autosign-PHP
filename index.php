...
<div data-page="index-4" class="page4"><div class="container"><div class="container"><div class="box-s"><form method="post"><span class="title-s p-b-34 p-t-27">Signer IPA </span><div class="txt2">only url's .ipa</div><div class="wrap-input100 validate-input" data-validate="Enter username"><input name="url" size="50" placeholder="Paste the link you want to sign" class="input100" required><span class="focus-input100" data-placeholder="🚀"></span></div><div class="container-login100-form-btn" onclick="makesgin()"><input  name="submit" type="submit" value="🚀	sign" class="login100-form-btn"  onclick="window.location.href='/'"></div></form></div></div><div class="app-card-2"><div class="content-block" style="margin-top:0px; margin-bottom:0px; padding-top:10px; padding-bottom:10px;"><h4 style="margin:0px;">Recent signature operations</h4></div><div class="list-block media-list"><ul><?php
